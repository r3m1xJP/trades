...
{
    public class CareerCollegeGroupController : Controller
    {
        ...
        public CareerCollegeGroupController()
        {
        ...
        [HttpPost]
        public ActionResult CCGExternalPost(FormCollection fc)
        {
